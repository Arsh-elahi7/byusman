...
A complete Flask HRMS for hackathon demos with role-based login, employee management, attendance, leave approvals, payroll, profile uploads, dashboards, charts, and responsive Bootstrap UI.
...
Add screenshots from your final hackathon run here.
